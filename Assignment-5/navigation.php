...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand " href="#" style="margin-left:60%;">Navbar</a>
    
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active" aria-current="page" href="<?php echo $mainurl;?>">Home</a>
        <a class="nav-link" href="#">About us</a>
        <a class="nav-link" href="<?php echo $mainurl;?>courselist">Courses</a>
        ...
        <li><a href="<?php echo $mainurl;?>manage-notification">Manage Notification</a></li>
        <li><a href="<?php echo $mainurl;?>manage-order">Manage Orders</a></li>        
        <li><a href="<?php echo $mainurl;?>change-password">Chanage Password</a></li>
        <li><a href="<?php echo $mainurl;?>manage-profile?deldata <?php echo $prof[0]["s_id"];?>" onclick="return confirm('Are you sure to remove your account?')">Delete Account</a></li>
...
<a class="nav-link" href="#">Cart <i class="bi bi-cart"><span class="badge badge-danger badge-sm bg-danger text-white">0</span></i></a>
